        ...
        <nav id="sidebarCollapse" class="collapse d-lg-block sidebar bg-white">
            <div class="position-sticky mt-3">
                ...
                <div class="list-group list-group-flush mx-2 mt-4">
                    <a href="#" class="list-group-item list-group-item-action py-3 " onclick="loadContent('/projeto/pages/')" data-url="">
                        <i class="bi-house fa-fw me-3"></i>Pagina Inicial
                    </a>


                    <?php if ($permissao == 1 || $permissao == 4) { ?>
                        <a href="#" class="list-group-item list-group-item-action py-3" onclick="loadContent('/projeto/pages/users/indexUsers.php')" data-url="/projeto/pages/users/indexUsers.php">
                    ...
                    <?php if ($permissao == 1 || $permissao == 4) { ?>
                    <a href="#" class="list-group-item list-group-item-action py-2" onclick="loadContent('/projeto/pages/training/indexTraining.php')" data-url="/projeto/pages/training/indexTraining.php">
                            Controle de Treinamentos
                        </a>
                        <?php } ?>

                        <a href="#" class="list-group-item list-group-item-action py-2" onclick="loadContent('/projeto/pages/training/listTraining.php')" data-url="/projeto/pages/training/listTraining.php">
                            Lista de Treinamentos
                        </a>
                        <a href="#" class="list-group-item list-group-item-action py-2" onclick="loadContent('/projeto/pages/inscription/indexInscription.php')" data-url="/projeto/pages/inscription/indexInscription.php">
                            Inscrições Pendentes
                        </a>

                    </div>

                    <a href="#" class="list-group-item list-group-item-action py-3" onclick="loadContent('/projeto/pages/company/indexCompany.php')" data-url="/projeto/pages/company/indexCompany.php">
                        <i class="bi bi-buildings fa-fw me-3"></i>Empresas
                    </a>
                    <a href="#" class="list-group-item list-group-item-action py-3" onclick="loadContent('/projeto/pages/employee/indexEmployee.php')" data-url="/projeto/pages/employee/indexEmployee.php">

                        <i class="bi bi-people me-3"></i>Funcionários
                    </a>


                    <a href="#" class="list-group-item list-group-item-action py-3 disabled" onclick="loadContent('/projeto')" data-url="/projeto">
            ...
            <div class="container-fluid p-2 ">
                ...
                <div class="flex-shrink-0 dropdown ms-auto me-2">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="dropdownUser2">
                        ...
                        <?php if ($permissao == 1 || $permissao == 4 && $numLinhas != 0) { ?>
                            <li>
                                <a class="text-decoration-none text-dark" href="#" onclick="loadContent('/projeto/pages/inscription/indexInscription.php')" data-url="/projeto/pages/inscription/indexInscription.php">
