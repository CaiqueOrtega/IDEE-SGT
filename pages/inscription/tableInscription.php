...
<div class="table-responsive">
    ...
    <table id="tabelaInscriptions" class="table table-hover table-striped" style="--bs-table-bg: transparent !important;">
        <thead>
            <tr>
                <th scope="col">NR</th>
                <th scope="col">Treinamento Solicitado</th>
        ...
        <?php
        if (empty($inscricoesData) && $idPermissao != 1 && $idPermissao != 4) { ?>
        ...
        <?php } else { ?>
            ...
            <tbody class="mt-1">
                <?php foreach ($inscricoesData as  $inscricao) {
