        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row card mt-4 py-2  mx-1 rounded-1" style='margin-bottom: -10px;'>
                    ...
                    <div class="col-md-12 d-flex flex-row justify-content-between align-items-center">
                        <h5>Alunos</h5>
                        <a href="#" class="btn btn-info-class btnToggleCollapse" data-bs-toggle="collapse" data-bs-target="#collapseExample3" aria-expanded="false" aria-controls="collapseExample" data-index="<?php echo $index; ?>">
                            <i class="icon bi bi-chevron-right fs-3" style="color:#58af9b;"></i>
                        </a>
